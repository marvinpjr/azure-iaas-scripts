...
.\config.cmd --deploymentgroup --deploymentgroupname "AzureVMs" --agent $env:COMPUTERNAME --runasservice --work '_work' --url 'https://dev.azure.com/marvin0051/' --projectname 'The One Parent Project' --auth PAT --token yyupbszopxddulfirrjx4yruwtxn2khbc57gc7plvjvnbbziquoq;
